# camera_ACTi_ACM_fixed_dome

mjpg="http://@IP@:@HTTP_PORT@/cgi-bin/encoder?USER=@USER@&PWD=@DPASSWORD@&GET_STREAM"
stream="rtsp://@USER@:@DPASSWORD@@@IP@:@RTSP_PORT@"
playerType="vlc"
user="@USER@"
password="@EPASSWORD@"
ptz=eval("{'down': False, 'rzoom': False, 'right': False, 'up': False, 'left': False}")
passkey="@PASSKEY@"
