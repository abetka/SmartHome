        ...
        if manufacturer == "atrea":
            ...
            if "requested_temperature" in stats:
                try:
                    ...
                    self.elkonet.setValue(clim, "requested_temperature", 0 if temp == 0 else temp - 1)
                except:
            ...
            if "setptemp" in stats:
                try:
                    ...
                    self.elkonet.setValue(clim, "setptemp", "0" if temp < 10 else str(temp - 10))
                except:
                    print 'Received bad temperature format from device'
            ...
            self.elkonet.setValue(clim, "down", None)
            ...
            if "desired" in stats:
                try:
                    ...
                    self.elkonet.setValue(clim, "desired", 0 if temp == 0 else temp - 1)
                except:
                    print 'Received bad temperature format from device'
            ...
            if "SetTemp" in stats:
                try:
                    ...
                    self.elkonet.setValue(clim, "SetTemp", 0 if temp == 0 else temp - 1)
                except:
                    print 'Received bad temperature format from device'
            ...
            if "setTemp" in stats:
                try:
                    ...
                    self.elkonet.setValue(clim, "setTemp", "0" if temp == 0 else str(temp - 1))
                except:
                    print 'Received bad temperature format from device'
            ...
            if "state" in stats:
                if "set temperature" in stats["state"]:
                    try:
                        ...
                        self.elkonet.setValue(clim, "set temperature", 0 if temp == 0 else temp - 1)
                    except:
                        print 'Received bad temperature format from device'
            ...
            if "set_temp" in stats:
                try:
                    ...
                    self.elkonet.setValue(clim, "set_temp", 0 if temp == 0 else temp - 1)
                except:
                    print 'Received bad temperature format from device'
