...
class Elkonet():
    ...
    def setValue(self, clim, manufacturer, value):
        ...
        if manufacturer == "atrea":
            ...
            self.elkonet.setValue(clim, "mode", "cool")
