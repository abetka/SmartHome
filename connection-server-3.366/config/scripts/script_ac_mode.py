...
class Elkonet():
    ...
    def setValue(self, clim, manufacturer, value):
        ...
        try:
            ac_value = DenormalizeAC(manufacturer, "mode", value)
        ...
        if manufacturer == "atrea":
            ...
            self.elkonet.setValue(clim, "mode", ac_value)
